(function () {
    ...
    var worker = new SharedWorker('shared-worker.js', 'my-shared-scope')
        ...
        , addWindow
        , sendMessage
        , Notifications = window.Notification || window.mozNotifications
        ;
    ...
    function askPermissionForNotifications() {
        ...
        Notifications.requestPermission(function () {
            console.log('Notification Permission = ' + Notifications.permission);
            if ('granted' !== Notifications.permission) {
                return;
            }
